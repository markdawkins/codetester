...
for ip in f:
        ...
        if __name__ == '__main__':
            ...
            send_command(shell, 'capwap ap secondary-base dummy 192.0.2.1')
            time.sleep(1)
            send_command(shell, 'capwap ap primary-base GRRWLC03 10.14.250.221')
            time.sleep(1)
            send_command(shell, '%confirm% reload')
