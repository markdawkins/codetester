...
net_connect.send_command('username admin privilege 15 secret <password>\n')
net_connect.send_command('username solar privilege 15 password <password>\)
net_connect.send_command('snmp-server community <password>\ RO')
net_connect.send_command('enable secret <password>\\n')
net_connect.send_command('snmp-server user M1bAcc355 ALLADMIN v3 auth md5 <password>\\n')
